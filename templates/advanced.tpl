  ...
  <form id="submission" method="post" action="/">
    ...
    <div id="parameters" class="has-tabs">
      ...
      <div id="tab-policy" class="tab selected">
        ...
        <ul>
          <li class="disabled init-disabled"><label title="Treaty participation in 2005." >2005 <span class="label"><span class="label-number">100</span><span>%</span></span></label>
            <input name="p2050" class="" type="range" min="0" max="100" step="5" value="100" data-prec="0" disabled="disabled"/>
            <div class="tick-wrap"><span class="tick" style="left:50%" >&bullet;</span></div></li>
          <li class="disabled init-disabled"><label title="Treaty participation by 2015." >2015 <span class="label"><span class="label-number">100</span><span>%</span></span></label>
            <input name="p2100" class="" type="range" min="0" max="100" step="5" value="100" data-prec="0" disabled="disabled"/>
            <div class="tick-wrap"><span class="tick" style="left:50%" >&bullet;</span></div></li>
          <li class="disabled init-disabled"><label title="Treaty participation by 2205." >2205 <span class="label"><span class="label-number">100</span><span>%</span></span></label>
...
<div id="content" class="hasnoruns">
  <div class="tabs">
    <a href="" class="selected" id="link-to-four-graphs">Basic Graphs</a>
    <a href="#" id="link-to-custom-graph">Advanced Graph</a>
    <a href="#" id="link-to-scc-graph">SCC Graph</a>
  </div>
  <div class="initial">
    {{! paragraphs_html }}
  </div>
