...
def run_loop(form):
    ...
    # out['data']['discount_rate'] = [l * 100 for l in out['data']['discount_rate']]
    # out['data']['discount_forward'] = [l * 100 for l in out['data']['discount_forward']]
    out['data']['discount_rate'][0] = None
    out['data']['discount_forward'][0] = None
    return jsonify(**out)
