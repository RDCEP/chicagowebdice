...
function [param] = OptimizeParam()
    ...
    % Special Params for Optimization
    % Testing out ways to represent choices for exogenous variables, e.g. miu

    param.optVariable = 'miu';
    %param.optInit = .2;
    
    param.conVariable = 'tempAtmosphere';
    
    param.c = 'vars.tempAtmosphere - 2';
    param.ceq = '[]';

    param.A = [];
    param.b = [];
    param.lb = repmat(0,1,60);
    param.ub = repmat(1,1,60);
    ...
    %% Emissions
    param.sig0 = .13148; % CO2-equivalent emissions-GNP ratio 2005 (effectively intensity)
    ...
    %% Participation
    param.partfract1 = 0.25372; % Fraction of emissions under control regime 2005
